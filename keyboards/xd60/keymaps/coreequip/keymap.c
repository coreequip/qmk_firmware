...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_all(_______, KC_P1, KC_P2, KC_P3, KC_P4, KC_P5, KC_P6, KC_P7, KC_P8, KC_P9, KC_P0, KC_PMNS, KC_PPLS, _______, _______,
                   ...
                   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PDOT, _______, _______, LCTRL(KC_PGUP), KC_PSLS,
                   _______, _______, _______, _______, _______, _______, LCTRL(KC_HOME), LCTRL(KC_PGDN), LCTRL(KC_END))
