...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_all(KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_DEL, KC_DEL,
                   _______, LALT(KC_F4), _______, RALT(KC_5), _______, _______, _______, RALT(KC_Y), _______, RALT(KC_P), KC_PSCR, BL_DEC, BL_INC, KC_APP,
                   _______, RALT(KC_Q), RALT(KC_S), _______, _______, RALT(S(KC_SCLN)), _______, _______, _______, _______, _______, _______, _______, _______,
                   _______, _______, _______, KC_MYCM, KC_CALC, _______, KC_VOLD, KC_VOLU, KC_MUTE, KC_MPRV, KC_MNXT, _______, _______, _______, KC_PGUP,
                   _______, _______, LM(2,MOD_LALT), KC_MPLY, KC_INS, _______, KC_HOME, KC_PGDN, KC_END),
